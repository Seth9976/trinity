...
private:
	...
	Tr2PostProcessRenderInfo::Texture RenderUpscaling( Tr2RenderTarget * dest, Tr2RenderContext & renderContext, Tr2UpscalingContextAL * upscalingContext, Tr2PPDynamicExposureEffect * dynamicExposure, ImageIO::PixelFormat outputFormat );
