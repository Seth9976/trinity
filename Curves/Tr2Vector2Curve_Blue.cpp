...
BLUE_DEFINE( Tr2Vector2Curve );
BLUE_DEFINE( Tr2Vector2Key );

Be::VarChooser Vector2InterpolationChooser[] =
{
	{ 
		"CONSTANT", 
		BeCast(CONSTANT), 
...
const Be::ClassInfo* Tr2Vector2Key::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2Vector2Key, "" )
		MAP_INTERFACE( Tr2Vector2Key )

		MAP_ATTRIBUTE( "time", m_time, "", Be::READWRITE | Be::PERSIST )
		MAP_ATTRIBUTE_WITH_CHOOSER( "interpolation", m_interpolation, "", Be::READWRITE | Be::PERSIST | Be::ENUM, Vector2InterpolationChooser )
...
const Be::ClassInfo* Tr2Vector2Curve::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2Vector2Curve, ":jessica-icon: tree/trivectorcurve.png\n:jessica-deprecated:" )
		MAP_INTERFACE( Tr2Vector2Curve )
