...
const Be::ClassInfo* Tr2TexturePackChannel::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2TexturePackChannel, "" )
		...
		MAP_ATTRIBUTE_WITH_CHOOSER( "channel", m_channel, "Channel to take from the input texture", Be::READWRITE | Be::PERSIST, ChannelChooser )
...
const Be::ClassInfo* Tr2TexturePipelineStepPack::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2TexturePipelineStepPack, "" )
		...
		MAP_ATTRIBUTE_WITH_CHOOSER( "format", m_format, "Resulting pixel format", Be::READWRITE | Be::PERSIST, Tr2RenderContextEnum_PixelFormat_Chooser )
